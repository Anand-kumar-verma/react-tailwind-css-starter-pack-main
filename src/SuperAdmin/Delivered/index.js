...
export default function Delivered() {
    ...
    return (
            <div>
                ...
                <div className=""><p><b><span className="font-bold text-purple-800">Number of Orders:</span>{" "}<span>{getallorder.filter((singleItem)=>singleItem.status.toLowerCase() === 'delivered').length}</span>  </b></p></div>
                <div className="text-white "> 
                    ...
                    {
                        getallorder.filter((singleItem)=>singleItem?.status.toLowerCase() === 'delivered').length === 0 ? <div className="bg-[#F3E8FF] grid grid-cols-5 px-24 py-6">
                                <div></div>
                                <div></div>
                            ...
                            <div className="h-72 overflow-y-scroll pb-4">
                                    <table class="table-auto w-full capitalize  p-2 bg-[#F3E8FF] pb-3">
                                        ...
                                        {getallorder.filter((singleItem)=>singleItem?.status.toLowerCase() === 'delivered').map((singleData, index) => {
                                            return (
                                            <tr
                                                key={index}
