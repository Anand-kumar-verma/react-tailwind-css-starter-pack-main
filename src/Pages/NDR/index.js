            ...
            <div className="pr-16">
                <div className="grid lg:grid-cols-5 gap-4">
                    ...
                    <div className="bg-white rounded-full shadow-xl ">
                        <p className="text-blue-500 px-6 py-2 flex justify-between"><span>Jun 3, 2023 - jun 2, 2023</span>
                            <CalendarTodayIcon />
                        </p>
                    </div>
                    <div className="bg-white rounded-full shadow-xl ">
                        <p className="text-blue-500 px-6 py-2 flex justify-between"><span>Zone</span>
                            <CalendarTodayIcon />
                        </p>
                    </div>
                    <div className="bg-white rounded-full shadow-xl ">
                        <p className="text-blue-500 px-6 py-2 flex justify-between"><span>Courier</span>
                            <CalendarTodayIcon />
                        </p>
                    </div>
                    <div className="bg-white rounded-full shadow-xl ">
                        <p className="text-blue-500 px-6 py-2 flex justify-between"><span>Payment Mode</span>
                            <CalendarTodayIcon />
                        </p>
                    </div>
                    <div className="bg-white rounded-full shadow-xl ">
                        <p className="text-blue-500 px-6 py-2 flex justify-between"><span>Shipment Mode</span>
                            <CalendarTodayIcon />
                        </p>
                    </div>
                ...
                <div>
                    <div className="bg-[#F3E8FF] mt-16 py-12">
